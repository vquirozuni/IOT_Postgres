...
class RemaView(TemplateView):
    ...
    def get(self, request, **kwargs):
        ...
        print("TemplateName: ", self.template_name)
    ...
    def get_context_data(self, **kwargs):
        ...
        print("MeasureParam: ", measureParam)
        ...
        print("selectedMeasure: ", selectedMeasure)
        ...
        for location in locations:
            print("Location.city: ", location.city.name)
            print("Location.country: ", location.country.name)
            stations = Station.objects.filter(location=location)
            for station in stations:
                print("Stations: ", station.user.login)
            print("selectedMeasure.name: ", selectedMeasure.name)
    ...
    def get_context_data(self, **kwargs):
        ...
        for location in locations:
            ...
            greaterCount = Data.objects.filter(
                station__in=stations, measurement__name=selectedMeasure.name,  time__gte=start.date(), time__lte=end.date(), value__gte=avgVal)
